...
(function(fn) {
    ...
    var warn = function() {
        ...
        var css = {
            ...
            style: [
                '#' + elementId + ' {transition:all 0.4s ease-in-out;position:fixed;z-index:999999;bottom:-20px;top:550px;left:0;right:0;opacity:0;text-align:center;padding:10px;background-color:#212121}',
